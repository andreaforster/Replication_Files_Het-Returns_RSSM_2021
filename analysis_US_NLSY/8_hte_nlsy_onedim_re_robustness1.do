...
log using "$logs/8_hte_nlsy_onedim_re_robustness1.txt", replace
...
est store men_II
	...
	* Marginal Effects Plot of Model II
	...
	marginsplot, ///
		...
		graph save onedim_men_robustness1.gph, replace


		graph export "$robust/nlsy_hte_margins_men_robustness1.pdf", replace
...
est store women_II
	...
	* Marginal Effects Plot for Model II
	...
	marginsplot, ///
		...
		graph save onedim_women_robustness1.gph, replace

		graph export "$robust/nlsy_hte_margins_women_robustness1.pdf", replace
...
esttab men_I men_II women_I women_II ///
	using "$robust/nlsy_hte_onedimension_robustness1.tex" ///
