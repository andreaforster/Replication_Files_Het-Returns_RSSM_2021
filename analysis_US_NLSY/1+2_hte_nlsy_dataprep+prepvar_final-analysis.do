...
*-------------------------------------------------------------------------------
* Delete wages outside the range of 1 to 100 dollars per hour
*-------------------------------------------------------------------------------

	forvalues x = 1994(2)2006 {
		recode h_wage_`x' (min/0.9=.)(100.01/max=.)
	}

*-------------------------------------------------------------------------------
* Deflate wages using the CPI-U 1983, rescaled to base year 2015
*-------------------------------------------------------------------------------
	...
	* convert to 2015 values
	forvalues x = 1994(2)2006 {
		replace h_wage_`x' = h_wage_`x' * cpi2015/cpi`x'
	}
