...
log using "$logs/8_hte_nlsy_twodim_re_robustness1.txt", replace
...
esttab men_rel_I men_rel_II women_rel_I women_rel_II ///
	using "$robust/nlsy_hte_rel_re_resid_robustness1.rtf" ///
	, nobaselevels label nodepvars se r2 replace 

esttab men_irr_I men_irr_II women_irr_I women_irr_II ///
	using "$robust/nlsy_hte_irr_re_robustness1.rtf" ///
	, nobaselevels label nodepvars se r2 replace  
...
graph save twodim_men_robustness1.gph, replace

graph export "$robust/nlsy_hte_margins_twodim_men_resid_robustness1.pdf", replace
...
graph save twodim_women_robustness1.gph, replace

graph export "$robust/nlsy_hte_margins_twodim_women_resid_robustness1.pdf", replace
