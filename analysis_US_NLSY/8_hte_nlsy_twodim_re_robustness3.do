...
log using "$logs/8_hte_nlsy_twodim_re_robustness3.txt", replace
...
est store men_irr_II
	...
	* Marginal Effects Plot for Model II 
	...
	marginsplot, ///
		...
		graph export "$robust/nlsy_hte_margins_irr_men_robustness3.pdf", replace
...
est store women_irr_II
	...
	* Marginal Effects Plot for Model II
	...
	marginsplot, ///
		...
		graph export "$robust/nlsy_hte_margins_irr_women_robustness3.pdf", replace
...
esttab men_rel_I men_rel_II women_rel_I women_rel_II ///
	using "$robust/nlsy_hte_rel_re_resid_robustness3.rtf" ///
	, nobaselevels label nodepvars se r2 replace 

esttab men_irr_I men_irr_II women_irr_I women_irr_II ///
	using "$robust/nlsy_hte_irr_re_robustness3.rtf" ///
	, nobaselevels label nodepvars se r2 replace  
...
graph save twodim_men_robustness3.gph, replace

graph export "$robust/nlsy_hte_margins_twodim_men_robustness3.pdf", replace
...
graph save twodim_women_robustness3.gph, replace

graph export "$robust/nlsy_hte_margins_twodim_women_robustness3.pdf", replace
