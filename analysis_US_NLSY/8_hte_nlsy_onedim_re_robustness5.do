...
* Model I
xtmixed lnwg c.ps_men college c.age_c || id: , mle variance 
est store men_I
...
est store men_II
	...
	* Marginal Effects Plot of Model II
	...
	marginsplot, ///
		...
		graph save onedim_men_robustness5.gph, replace
		
		graph export "$robust/nlsy_hte_margins_men_robustness5.pdf", replace
...
* Model I
xtmixed lnwg c.ps_women college age_c || id: , mle variance
est store women_I
...
est store women_II
	...
	* Marginal Effects Plot for Model II
	...
	marginsplot, ///
		...
		graph save onedim_women_robustness5.gph, replace

		graph export "$robust/nlsy_hte_margins_women_robustness5.pdf", replace
