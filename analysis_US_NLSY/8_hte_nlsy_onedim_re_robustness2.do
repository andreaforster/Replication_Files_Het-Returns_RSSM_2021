...
est store men_II
	...
	* Marginal Effects Plot of Model II
	...
	marginsplot, ///
		...
		graph save onedim_men_robustness2.gph, replace

		graph export "$robust/nlsy_hte_margins_men_robustness2.pdf", replace
...
est store women_II
	...
	* Marginal Effects Plot for Model II
	...
	marginsplot, ///
		...
		graph save onedim_women_robustness2.gph, replace

		graph export "$robust/nlsy_hte_margins_women_robustness2.pdf", replace
...
esttab men_I men_II women_I women_II ///
	using "$robust/nlsy_hte_onedimension=_robustness2.tex" ///
